...
<form>
  <div class="form-group">
    <div class="col-md-4 mb-3">
      ...
      <input type="text" class="form-control is-valid" id="validationServer01" placeholder="database title"  required>
    ...
    <div class="col-md-6 mb-3">
      ...
      <input type="text" class="form-control is-valid" id="validationServer02" placeholder=" database Description" required>
    </div>
   <div class="col-md-6 mb-3">
     ...
     <select class="custom-select" value ="Open this select menu" required>
      ...
      <input type="number" class="form-control is-valid" id="validationServer02" placeholder="database cost">
        <div class="invalid-feedback">)
