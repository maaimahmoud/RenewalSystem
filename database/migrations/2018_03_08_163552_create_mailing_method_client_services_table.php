...
class CreateMailingMethodClientServicesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        ...
        Schema::create('mailing_method_client_services', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('mailing_method_client_services');
    }
}
