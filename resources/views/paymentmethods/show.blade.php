              ...
              <div class="modal-body">
                 <form action="{{url('/paymentmethods/create')}}" method="POST">
                    ...
                    {{ method_field('POST') }}
                      ...
                      <div class="md-form form-sm">
                          <i class="fa fa-envelope prefix"></i>
                          <label for ="modalservicecategoryForm"> Number of months</label>
                          <input type="number" name="months"  id="modalpaymentmethodinput" min=1 class="form-control form-control-sm" required>
                      </div>
